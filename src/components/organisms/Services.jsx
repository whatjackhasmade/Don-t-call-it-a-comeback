			...
			<ServicesContainer>
				<div className="service">
					...
					<p>
						...
						functional interfaces that users can interact and navigate with.
					</p>
					<p>
						I know the fundamentals of HTML, CSS and JavaScript but often use
						React as part of my tech-stack
					</p>
					<Image
				...
				<div className="service">
					...
					<p>
						As well as front-end development expertise, I have broadened my
						skill set to include backend languages such as PHP and Node.js
					</p>
					<p>
						Assisting the front-end of a website with data from bespoke APIs, I
						am able to take full control of any project and achieve specific
						requirements that a client may have.
					</p>
					<Image
						className="service__image"
						src={imageBackend}
				...
				<div className="service">
					...
					<p>
						Not only do websites that load slow creative negative experiences
						with digital products, but they also affect bottom line sales, SEO
						and damage business overall.
					</p>
					<p>
						I take pride in optimising any and all of my products to load as
						quickly as possible, no matter the connection or device.
					</p>
					<Image
						className="service__image"
						src={imageSpeed}
				...
				<div className="service">
					...
					<p>
						With several years of experience in Adobe XD, Photoshop,
						Illustrator, InDesign, Premiere Pro and Lightroom.
					</p>
					<p>
						It is safe to say I've got the knowledge to design a product that
						not only aesthetically pleases the eyes, but also a product that is
						usable to consumers.
					</p>
					<Image
						className="service__image"
