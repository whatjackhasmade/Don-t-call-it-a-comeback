						...
						<Container className="cv">
							...
							<CVAbout>
								...
								<p>
									...
									improve how businesses present themselves in the form of brand
								...
								<p>
									...
									creating bespoke backend systems, my true passion lies in the
									front-end development of websites. Turning designs into
									functional pages that represent brands or enable users to make
							...
							<Timeline>
								{myTimeline.map(chapter => (
									<TimelineItem
										...
										className={
											chapter.type !== this.state.timelineFilter
												? "hide"
												: "show"
										}
									>
