module.exports = {
	siteTitle: "WhatJackHasMade, Jack Pritchard, Award Winning Developer", // Site title.
	siteTitleShort: "WhatJackHasMade", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation.
